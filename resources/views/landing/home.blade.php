...
<section class="py-20" style="background-color: #f8f6f1;">
    <div class="container mx-auto px-6">
        <div class="text-center mb-14">
            <p class="text-xs uppercase tracking-[0.3em] text-[#004d2c] mb-3">Our Blog</p>
            <h2 class="text-3xl md:text-4xl font-semibold text-neutral-900">Latest News</h2>
        </div>
        ...
        <div class="text-center mt-14">
            <a href="{{ route('blog.index') }}" class="btn-secondary">View All News</a>
        </div>
    </div>
</section>
@endif
